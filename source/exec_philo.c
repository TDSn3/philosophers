...
/*   Updated: 2022/12/19 23:05:57 by tda-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*exec_philo(void *data)
{
	...
	while (1)
	{
		if (check_die(__.list_main, __.own_ll_p, __.eat, &__)
			|| take_first_fork(&__)
			|| philo_sleep(&__)
			|| check_die(__.list_main, __.own_ll_p, __.eat, &__))
			return (NULL);
...
static int	take_first_fork(t_l_ep	*__)
{
	...
	if (__->err)
	{
		return_error(1, __->err, 0);
		return (1);
	}
	if (check_die2(__->list_main, __->own_ll_p, __->eat, __))
	{
